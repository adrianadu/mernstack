...
function App() {
  ...
  const handleInput = () => {
    ...
    let badwords = ["bad|stupid|useless|crazy|nonsense"];
    ...
    if (words9.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "The owner of this bot is Mresult";
        inputRef.value = ""; 
      }, 2000);
    }
    ...
    if (words10.test(document.querySelector("#input").value)) {
      ...
      setTimeout(() => {
        getBotMessage.innerText =
          "Treasure is a programmer based on ReactJS and NodeJS he is the owner me";
        inputRef.value = ""; 
      }, 2000);
    }
    ...
    let food = [
      "The food was good|The food was bad|The food was expensive|The food was served late|The food tasted funny|The food tasted cheap|The food was disgusting",
    ]; 
    let words12 = new RegExp(food);
    if (words12.test(document.querySelector("#input").value)) {
    
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "Sorry for the inconvience, Will report this to higher Authorities";
        inputRef.value = ""; 
      }, 2000);
    }
    let Chef = [
      "Who cooked this food|what's the name of the chef|Who is the chef|Who made this food|Chef's name please",
    ]; 
    let words13 = new RegExp(Chef);
    if (words13.test(document.querySelector("#input").value)) {
    
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "The Chef's name is Gordon Ramsey";
        inputRef.value = ""; 
      }, 2000);
    }
    let Mresult = [
      "What is Mresult|Who is Mresult|Where do you work",
    ]; 
    let words14 = new RegExp(Mresult);
    if (words14.test(document.querySelector("#input").value)) {
    
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "Mresult is an AI& ML based Company located In Whitefiled";
        inputRef.value = ""; 
      }, 2000);
    }
    let MresultWork = [
      "What does Mresult do|What is the role of Mresult|What's the role of Mresult",
    ]; 
    let words15 = new RegExp(MresultWork);
    if (words15.test(document.querySelector("#input").value)) {
    
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "MResult is a leading data & analytics intelligence technology solutions provider to companies that value insights from information as a competitive advantage.";
        inputRef.value = ""; 
      }, 2000);
    }
